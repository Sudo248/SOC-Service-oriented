package com.sudo248.chatservice.service.impl;
...
import com.sudo248.chatservice.internal.DiscoveryService;
import com.sudo248.chatservice.repository.ChatRepository;
import com.sudo248.chatservice.repository.UserRepository;
    ...
    public Conversation getConversationByTopic(String userId, String topic) {
        ...
        if (conversation.isPresent()) {
            ...
            conversationValue = new Conversation(
                    ...
                    "user_default.png",
                    discoveryService.getUserIdBySupplierId(userIds[0]),
                    userIds[1],
                    new ArrayList<>(),
