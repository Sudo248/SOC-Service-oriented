...
public class SupplierProductController {
    ...
    @GetMapping("/supplierId/{supplierId}/productId/{productId}")
    public ResponseEntity<BaseResponse<?>> getProductInfoBySupplierIdProductId(@PathVariable("supplierId") String supplierId, @PathVariable("productId") String productId ){
        SupplierProductCartDto productDto = supplierProductService.getProductInfoBySupplierIdProductId(supplierId, productId);
        return BaseResponse.ok(productDto);
    }
    //call from other service
    @GetMapping("/service/supplierId/{supplierId}/productId/{productId}")
    public SupplierProductCartDto getProductInfoBySupplierIdProductIdV2(@PathVariable("supplierId") String supplierId, @PathVariable("productId") String productId ){
